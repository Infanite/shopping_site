	...
	<div class="header-top">
		<div class="container">
			...
			<div class="header-left">		
					...
					@if(Auth::check())
					{
						<li ><a class="lock"  href="{{url('user/logout')}}"  >Logout</a></li>
						{{Auth::user()->name}}
					}
					@else
					{
		...
		<div class="container">
		  ...
		  <div class=" h_menu4">
				...
				<li><a class="color4" href="{{url('blog')}}">Blog</a></li>				
				 ...
				 @foreach($d as $fetch)
				   <div class="cart-sec simpleCart_shelfItem">
						<div class="cart-item cyc">
							 <?php $images = json_decode($fetch->image); ?>
							<img src="{{url($images[0])}}" width="70px" height="80px" class="img-responsive" alt="">
						</div>
					   <div class="cart-item-info">
						<h3><a href="#"></a><span>{{$fetch->name}}</span></h3>
						<ul class="qty">
							<li><p>Size :{{$fetch->size}}</p></li>
							<li><p>Qty :{{$fetch->added_cart_products}}</p></li>
						</ul>
